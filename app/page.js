...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const lenis = new Lenis({
      duration: 1.1, // higher = smoother / slower
    ...
    // lock scroll until the preloader finishes (page.js timeline calls start())
    lenis.stop();
    ...
    // smooth in-page anchor navigation (#work, #about, ...)
  ...
  useGSAP(
    () => {
      ...
      master
        ...
        .add(() => lenisRef.current && lenisRef.current.start())
